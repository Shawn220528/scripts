...
if (process.env.NFHKAPP2 && process.env.NFHKAPP2.indexOf('@') > -1) {
    usertokenArr = process.env.NFHKAPP2.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    usertokenArr.push(process.env.NFHKAPP2)
}
var pid = ''
if (process.env.NFHKPID2 && process.env.NFHKPID2.indexOf('@') > -1) {
    pid = process.env.NFHKPID2.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    pid = process.env.NFHKPID2
}
var indexArr = []
if (process.env.NFHKINDEX2 && process.env.NFHKINDEX2.indexOf(',') > -1) {
    indexArr = process.env.NFHKINDEX2.split(',');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    indexArr = process.env.NFHKINDEX2
}
/*
var exnum = 200
