...
if (process.env.NFHKAPP5 && process.env.NFHKAPP5.indexOf('@') > -1) {
    usertokenArr = process.env.NFHKAPP5.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    usertokenArr.push(process.env.NFHKAPP5)
}
var pid = ''
if (process.env.NFHKPID5 && process.env.NFHKPID5.indexOf('@') > -1) {
    pid = process.env.NFHKPID5.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    pid = process.env.NFHKPID5
}
var indexArr = []
if (process.env.NFHKINDEX5 && process.env.NFHKINDEX5.indexOf(',') > -1) {
    indexArr = process.env.NFHKINDEX5.split(',');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    indexArr = process.env.NFHKINDEX5
}
/*
var exnum = 200
