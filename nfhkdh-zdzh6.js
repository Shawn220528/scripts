...
if (process.env.NFHKAPP6 && process.env.NFHKAPP6.indexOf('@') > -1) {
    usertokenArr = process.env.NFHKAPP6.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    usertokenArr.push(process.env.NFHKAPP6)
}
var pid = ''
if (process.env.NFHKPID6 && process.env.NFHKPID6.indexOf('@') > -1) {
    pid = process.env.NFHKPID6.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    pid = process.env.NFHKPID6
}
var indexArr = []
if (process.env.NFHKINDEX6 && process.env.NFHKINDEX6.indexOf(',') > -1) {
    indexArr = process.env.NFHKINDEX6.split(',');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    indexArr = process.env.NFHKINDEX6
}
/*
var exnum = 200
