...
if (process.env.NFHKAPP3 && process.env.NFHKAPP3.indexOf('@') > -1) {
    usertokenArr = process.env.NFHKAPP3.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    usertokenArr.push(process.env.NFHKAPP3)
}
var pid = ''
if (process.env.NFHKPID3 && process.env.NFHKPID3.indexOf('@') > -1) {
    pid = process.env.NFHKPID3.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    pid = process.env.NFHKPID3
}
var indexArr = []
if (process.env.NFHKINDEX3 && process.env.NFHKINDEX3.indexOf(',') > -1) {
    indexArr = process.env.NFHKINDEX3.split(',');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    indexArr = process.env.NFHKINDEX3
}
/*
var exnum = 200
