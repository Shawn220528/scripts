...
if (process.env.NFHKAPP1 && process.env.NFHKAPP1.indexOf('@') > -1) {
    usertokenArr = process.env.NFHKAPP1.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    usertokenArr.push(process.env.NFHKAPP1)
}
var pid = ''
if (process.env.NFHKPID1 && process.env.NFHKPID1.indexOf('@') > -1) {
    pid = process.env.NFHKPID1.split('@');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    pid = process.env.NFHKPID1
}
var indexArr = []
if (process.env.NFHKINDEX1 && process.env.NFHKINDEX1.indexOf(',') > -1) {
    indexArr = process.env.NFHKINDEX1.split(',');
    console.log(`您选择的是用"@"隔开\n`)
} else {
    indexArr = process.env.NFHKINDEX1
}
/*
var exnum = 200
